...
func (_mock *MockUserStore) ListUsers(ctx context.Context, limit int32) ([]db.ListUsersRow, error) {
...
func (_c *MockUserStore_ListUsers_Call) Return(listUsersRows []db.ListUsersRow, err error) *MockUserStore_ListUsers_Call {
	_c.Call.Return(listUsersRows, err)
	return _c
}

func (_c *MockUserStore_ListUsers_Call) RunAndReturn(run func(ctx context.Context, limit int32) ([]db.ListUsersRow, error)) *MockUserStore_ListUsers_Call {
	_c.Call.Return(run)
	return _c
}
