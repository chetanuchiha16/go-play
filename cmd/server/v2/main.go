...
func main() {
	...
	fuego.Delete(authGroup, "/users/{id}", userHandler.DeleteUser, option.Security(openapi3.SecurityRequirement{"bearerAuth": []string{}}), option.Header("Authorization", "Bearer token", param.Required()))
